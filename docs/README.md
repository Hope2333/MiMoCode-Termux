...
This directory is the single source of truth for the current MiMoCode Termux packing/runtime workflow.
...
- Old generated `artifacts/staged`, `packing/deb/work`, `packing/pacman/src` can contain stale runtime versions
